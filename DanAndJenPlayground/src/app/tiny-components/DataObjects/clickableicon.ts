...
export class ClickableIcon {
    ...
    public static getAvatarIcon(description: string, skypeId: string, name: string, value: string, image: string, size?: number): ClickableIcon {
        let icon: ClickableIcon = new ClickableIcon();
    ...
    public static getImageIcon(description: string, altText: string, image: string): ClickableIcon {
        let icon: ClickableIcon = new ClickableIcon();
    ...
    public static getClassBasedICon(description: string, fontAwesomeClass: string, altText: string): ClickableIcon {
        let icon: ClickableIcon = new ClickableIcon();
    ...
    public setDecorativeOnly(isDecorative: boolean): ClickableIcon {
    ...
    public setSize(size: number): ClickableIcon {
        this.size = size;
        return this;
    }
