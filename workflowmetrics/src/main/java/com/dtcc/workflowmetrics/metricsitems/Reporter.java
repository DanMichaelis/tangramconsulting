...
public class Reporter {
    ...
    public Reporter setSelf(String self) {
        this.self = self;
    ...
    public Reporter setKey(String key) {
        this.key = key;
    ...
    public Reporter setEmailAddress(String emailAddress) {
    ...
    public Reporter setAvatarUrls(HashMap<String, String> avatarUrls) {
    ...
    public Reporter setDisplayName(String displayName) {
    ...
    public Reporter setActive(Boolean active) {
        this.active = active;
    ...
    public Reporter setTimeZone(String timeZone) {
